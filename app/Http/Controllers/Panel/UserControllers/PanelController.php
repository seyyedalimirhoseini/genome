...
class PanelController extends Controller
{
    ...
    {
        $courses=Course::all();
        return view('Panel.User-Panel.user-details',compact('courses'));
    }
    ...
    public function edit()
    {
        ...
        return view('Panel.User-Panel.user-edit',compact('user','states','courses'));
    }
...
//        $new_file_name = Input::file('image')->getClientOriginalExtension();
