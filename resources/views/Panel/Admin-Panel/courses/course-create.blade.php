...
@section('content')
    <div class="container">
        <div class="user-details">
            ...
            <div class="container">
                <form class="form margin-top-0" action="{{Route('courses.store')}}" method="post">
                    {{csrf_field()}}
                    <div class="input-div">
                        <div class="row">
                            <div class="col-md-6 @if ($errors->has('title')) has-error @endif">
                                <label for="title"><i class="fa fa-asterisk"></i>عنوان دوره :</label>
                                <input type="text"  name="title" id="title" placeholder="عنوان دوره را وارد کنید..." value="{{old('title')}}">
                                @if ($errors->has('title'))
                            ...
                            <div class="col-md-6 @if ($errors->has('points')) has-error @endif">
                                ...
                                <input type="text"  name="points" id="points" placeholder="امتیاز دوره را وارد کنید..." value="{{old('points')}}" >
                            ...
                            <div class="col-md-6 @if ($errors->has('date')) has-error @endif">
                                ...
                                <input type="text" name="date" id="date" class="observer-example" placeholder="تاریخ برگزاری دوره را وارد کنید..." >
                                @if ($errors->has('date'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-6 @if ($errors->has('clock')) has-error @endif">
                                ...
                                <input type="text" name="clock"   id="clock" data-align="top" data-autoclose="true" class="clockpicker" placeholder="ساعت برگزاری دوره را وارد کنید..." >
                                @if ($errors->has('clock'))
                                    <span class="invalid-feedback" role="alert">
                             ...
                             <div class="col-md-6 @if ($errors->has('price')) has-error @endif">
                                ...
                                <input type="text" name="price"   id="price"  placeholder="قیمت دوره را وارد کنید..." >
                                @if ($errors->has('price'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-6 confirm-btn">
                                <button type="submit" class="login-btn">افزودن دوره</button>
