...
@section('content')
    <div class="container">
        <div class="user-details">
            ...
            <div class="container">
                <form class="form" action="{{Route('file.store')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="input-div">
                        <div class="row">
                            <div class="col-md-6 @if ($errors->has('name')) has-error @endif">
                                <label for="name"><i class="fa fa-asterisk"></i>نام فایل :</label>
                                <input type="text" name="name" id="name" placeholder="نام فایل را وارد کنید..." value="{{old('name')}}">
                                @if ($errors->has('name'))
                            ...
                            <div class="col-md-12  @if ($errors->has('body')) has-error @endif">
                                ...
                                <textarea type="text" name="body" id="body" placeholder="توضیحاتی در مورد فایل وارد کنید...">{{old('body')}}</textarea>
                                @if ($errors->has('body'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-6 confirm-btn">
                                <button type="submit" class="login-btn">افزودن فایل</button>
