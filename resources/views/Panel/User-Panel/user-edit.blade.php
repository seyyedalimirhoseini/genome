...
@section('content')
    <div class="container">
        <div class="user-details">
            ...
            <div class="container">
                <form class="form" action="{{Route('user.update',['id'=>$user->id])}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="input-div">
                        <div class="row">
                            ...
                            <div class="col-md-7 confirm-btn">
                                ...
                                <a class="cancel-btn" href="{{Route('user.panel')}}">انصراف</a>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                $('select[name="state"]').on('change', function() {
                    ...
                    if(stateID) {
                        $.ajax({
                            ...
                            // },
                            url:"{{url('user/edit/ajax/')}}/"+stateID,
