        ...
        <div class="page-top">
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown ">
                        <a href="{{Route('home.page')}}" class="dropdown-toggle">
                            <i class="icon-home"></i>
                        </a>
...
{{--                            <img alt="" class="img-circle" src="{{URL('images/'.auth()->user()->image)}}"/>--}}
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            <li>
                                ...
                                <a href="app_inbox.html">
                                    <i class="icon-envelope-open"></i> صندوق ورودی من
